...
const LockMask = () => {
    ...
    >
        <div style={{
            ...
            <LinearProgress style={ProgressBarStyle} variant="determinate" value={(1-delta/(30*86400*1000))*100} />
            <Typography
                style={{
                    textAlign: 'center',
                }}
            ...
            >
                ...
                <br />
                {readableTime['days']} 日 {readableTime['hours']} 時 {readableTime['minutes']} 分 {readableTime['seconds']} 秒
            </Typography>
        </div>
    </Backdrop>;
};
